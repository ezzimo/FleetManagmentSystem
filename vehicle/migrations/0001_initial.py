# Generated by Django 3.1.2 on 2021-08-14 21:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(help_text='Anssurance Company Email', max_length=65, verbose_name='Email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=125, unique=True)),
                ('gross_vehicle_weight', models.PositiveSmallIntegerField(verbose_name='Gross vehicle weight')),
                ('gross_combined_weight', models.PositiveSmallIntegerField(verbose_name='Gross combined weight')),
                ('total_length_L', models.PositiveSmallIntegerField(verbose_name='Total length L')),
                ('total_width_W', models.PositiveSmallIntegerField(verbose_name='Toltal width W')),
